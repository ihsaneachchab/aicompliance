        ...
        __html: `
          ...
          function handleRegister(event) {
            ...
            if (data.password !== data.confirmPassword) {
              Utils.showNotification('error', 'Les mots de passe ne correspondent pas');
              return false;
            }

            if (data.password.length < 8) {
              Utils.showNotification('error', 'Le mot de passe doit contenir au moins 8 caractères');
              return false;
            }
            ...
            const user = {
              ...
              service: data.selectedService || 'iso9001',
              role: 'user',
              avatar: null,
              phone: data.phone,
            ...
            Utils.showNotification('success', 'Compte créé avec succès ! Bienvenue 🎉');
